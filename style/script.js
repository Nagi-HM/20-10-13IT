window.addEventListener('load', () => {
    const messages = [
        ...
        "Cảm ơn các bạn vì đã luôn đồng hành, giúp đỡ và tạo nên một tập thể thật tuyệt vời 💕",
        ...
        "Ngày 20/10 là dịp đặc biệt để nói lời cảm ơn tới những cô gái tuyệt vời của lớp — cảm ơn vì đã luôn là “bông hoa” làm lớp học trở nên sinh động và đáng nhớ hơn 💫"
    ];
